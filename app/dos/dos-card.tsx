      ...
      <div className="w-full max-w-xs">
        <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
          ...
          <div className="px-7 pt-9 pb-8 flex flex-col items-center text-center">
            ...
            {/* Name — two lines */}
            <h1 className="text-2xl font-semibold text-stone-900 tracking-wide leading-snug mb-1.5">
              {NAME_LINE1}
              <br />
              {NAME_LINE2}
            </h1>
            ...
            {/* Title */}
            <p className="text-base text-stone-500 mb-1.5 tracking-wide">
              {TITLE}
            </p>

            {/* Specialty */}
            <p className="text-sm text-stone-400 italic mb-5 leading-snug">
            ...
            {/* Action buttons — equal height, Save Contact centered */}
            <div className="grid grid-cols-3 gap-2 w-full mb-6">
              <a
                href={`sms:+1${PHONE}`}
                className="flex flex-col items-center justify-center gap-2 h-[70px] rounded-xl bg-stone-900 text-white hover:bg-stone-700 active:scale-95 transition-all"
              >
              ...
              <button
                onClick={saveContact}
                className="flex flex-col items-center justify-center gap-2 h-[70px] rounded-xl bg-stone-900 text-white hover:bg-stone-700 active:scale-95 transition-all cursor-pointer"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                  <circle cx="12" cy="7" r="4" />
                </svg>
                <span className="text-sm font-medium text-center leading-tight">Save<br />Contact</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium text-center leading-tight">Call</span>
              </a>
            </div>
